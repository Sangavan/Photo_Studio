      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative flex items-center justify-center w-11 h-11 rounded-xl shadow-lg overflow-hidden"
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            {/* Book Now Button */}
            <Link to="/booking"
              className="flex items-center gap-2 text-white px-4 py-2.5 rounded-xl text-sm font-bold transition duration-200 shadow-lg"
