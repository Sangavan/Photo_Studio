    ...
    <div className="relative bg-blue-950 min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-2xl blur-md opacity-40"
              ...
              {/* Main badge content */}
              <div className="relative flex items-center gap-3 px-5 py-3 badge-led-glow"
                  style={{
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <span className="text-xs font-bold text-blue-400 uppercase"
                      style={{ letterSpacing: '0.2em' }}>Photography Studio</span>
                    <div className="w-1 h-1 rounded-full bg-blue-500"></div>
                  </div>
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <p className="text-lg md:text-xl text-blue-300 font-medium italic">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Link
            to="/booking"
            className="flex items-center justify-center gap-3 text-white font-bold px-8 py-3.5 rounded-xl text-base transition duration-200"
            style={{
              background: 'linear-gradient(135deg, #1E40AF, #3B82F6)',
          ...
          <Link
            to="/portfolio"
            className="flex items-center justify-center gap-3 font-bold px-8 py-3.5 rounded-xl text-base transition duration-200 border-2"
            style={{
              borderColor: '#3B82F6',
              color: '#60A5FA',
        ...
        {/* Stats */}
        <div className="flex flex-col sm:flex-row gap-0 justify-center border border-blue-800 rounded-2xl overflow-hidden max-w-lg mx-auto"
          style={{ background: 'linear-gradient(135deg, #0a162888, #1e3a8a22)' }}>

          <div className="flex-1 py-4 px-6 text-center border-b sm:border-b-0 sm:border-r border-blue-800">
